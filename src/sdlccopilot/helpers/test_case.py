...
class TestCaseHelper:
    ...
    def generate_test_cases_from_llm(self, functional_documentation):
        try:
            logging.info("Generating test cases with LLM...")
            user_query =  f"Create test cases for the this project functional documentation: {functional_documentation}" 
    ...
    def revised_test_cases_from_llm(self, test_cases, backend_code, user_feedback):
        try:
